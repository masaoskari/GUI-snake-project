...
####################################################################
*
* This is a implementation file where is all GameBoard class method
* implementations. I have only implemented methods returnSnake() and
* returnFood(). But here you will find more details how different methods are
* implemented.
*
* ===========================
* Program author
...
std::deque<Point> GameBoard::returnSnake()
{
    //Returns snake parts coordinates in deque.
    return snake_;
}
